-- Add new categories to Hobbipedia database
-- Excludes existing categories: Cycling, Swimming, Photography, Running, Hiking, Yoga, Gaming, Cooking, Gardening, Music
...
('Astronomy', 'astronomy', 'Study of celestial objects and space', '🔭', 'navy'),
...
-- Sports Continued
('Basketball', 'basketball', 'Team sport with hoops and dribbling', '🏀', 'orange'),
